# Terraform for Databricks — Code Repository

This repo contains the Terraform code accompanying a 3-part Medium series on managing Databricks with Terraform.
...
- A Databricks account (Premium SKU for Unity Catalog)

## Usage

Read it in the blog posts, or clone the repo and run the code yourself!
